...
export default function Filters ({handleEntries,updateSearchTerm, onSubmitSearch }) {
    const [open, setOpen] = useState(false)
   
    return (
        <div className="mt-4 flex items-center gap-2">
            <div className="flex space-x-4 border-r-4 border-gray-300 px-4">
                <select className="outline-none w-50 border-b-2 px-4" onChange={(e) => handleEntries(+e.target.value)}>
            ...
            <div className="border-r-4 border-gray-300 flex items-center justify-center px-4 pt-1">
                ...
                {open && <form action="" onSubmit={(e) => {e.preventDefault(); onSubmitSearch()}}>
